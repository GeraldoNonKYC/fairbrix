# Support for Output Descriptors in Fairbrix Core

Since Fairbrix Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `fbx1...` for mainnet or `tfbx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Fairbrix Core wallets, a convenience function `combo` is

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fairbrix-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fairbrix-tx [options] <hex-tx> [commands]  Update hex-encoded fairbrix transaction\n" +
            "or:     fairbrix-tx [options] -create [commands]   Create hex-encoded fairbrix transaction\n" +
            "\n";

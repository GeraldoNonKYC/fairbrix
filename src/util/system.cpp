...
const char * const BITCOIN_CONF_FILENAME = "fairbrix.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fairbrix";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Fairbrix";
#else
    // Unix-like
    return pathRet / ".fairbrix";
#endif
#endif
}

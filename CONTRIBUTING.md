Contributing to Fairbrix Core
============================

The Fairbrix Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Fairbrix Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/fairbrix-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to fairbrix-qt
...
The following applies to code changes to the Fairbrix Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fairbrix
Network Protocol consensus changes.

Whether a pull request is merged into Fairbrix Core rests with the project merge
...
Patches that change Fairbrix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fairbrix consensus, it must have been
...
The project leader is the release manager for each Fairbrix Core release.

...
bech32_templates = [
  ...
  ('fbx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('fbx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('fbx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('fbx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tfbx',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfbx',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfbx',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfbx',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tfbx',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfbx',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfbx',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfbx',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rfbx',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rfbx',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rfbx',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rfbx', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tfbx',   17, 32, Encoding.BECH32M, False, False, False),
  ('rfbx',  3,  1, Encoding.BECH32M, False, False, False),
  ('fbx',   15, 41, Encoding.BECH32M, False, False, False),
  ('tfbx',    0, 16, Encoding.BECH32,  False, False, False),
  ('rfbx',  0, 32, Encoding.BECH32,  True,  False, False),
  ('fbx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tfbx',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rfbx',  0, 20, Encoding.BECH32,  False, False, True),
  ('fbx',    0, 20, Encoding.BECH32M, False, False, False),
  ('tfbx',    0, 32, Encoding.BECH32M, False, False, False),
  ('rfbx',  0, 20, Encoding.BECH32M, False, False, False),
  ('fbx',    1, 32, Encoding.BECH32,  False, False, False),
  ('tfbx',    2, 16, Encoding.BECH32,  False, False, False),
  ('rfbx', 16, 20, Encoding.BECH32,  False, False, False),
]

...
"""Verify that starting fairbrix with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fairbrix with -h for help text")
        ...
        self.log.info("Start fairbrix with -version for version information")
        ...
        self.log.info("Start fairbrixd with -fakearg to make sure it does not start")
